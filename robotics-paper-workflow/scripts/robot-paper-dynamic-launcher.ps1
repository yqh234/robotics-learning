...
$openDexTranslation = New-Object System.Windows.Forms.ToolStripMenuItem("Open PoseCNN analysis")
$openRoboTranslation = New-Object System.Windows.Forms.ToolStripMenuItem("Open AnyGrasp analysis")
